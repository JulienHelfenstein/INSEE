...
```{r simulation}
    ...
    for (i in 1:50) {
        ...
        timer$start("ctree")
        syn_ctree = syn(df, method = "ctree", visit.sequence = visit_sequence, seed = i)
        timer$stop("ctree")
        ...
        timer$start("cart")
        syn_cart = syn(df, method = "cart", visit.sequence = visit_sequence, seed = i)
        timer$stop("cart")
        ...
        timer$start("rf")
        syn_rf = syn(df, method = "rf", visit.sequence = visit_sequence, seed = i)
        timer$stop("rf")
        ...
        timer$start("para")
        syn_para = syn(df, method = "para", visit.sequence = visit_sequence, seed = i)
        timer$stop("para")
