...
```{r tests}
    ...
    repli = c("MALE", 83, "65+", "URBAN", "BELOW 20,000", "Lubuskie", "POST-SECONDARY OR HIGHER", "liberal arts", "RETIRED", "WIDOWED", "MIXED", 15, "ONE CAN'T BE TOO CAREFUL", "YES", "NO OPINION", "NO", 2, "NO", "NO", "NO", "NO", "NONE", 160, 65, 25.390625)
```