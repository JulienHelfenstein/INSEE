...
```{r graphiques}
    ...
    png("PlotTaillePoidsAge.png", width = 1080, height = 1080)
    ggplot(df, aes(x = df$weight, y = df$height, color = df$sex)) +
        geom_point()
    dev.off()

    ggplot(df, aes(x = df$depress, y = df$bmi, color = df$sex)) +
        geom_point()
    ...
    png("PropensionNofriendDepress.png", width = 1080, height = 1080)
