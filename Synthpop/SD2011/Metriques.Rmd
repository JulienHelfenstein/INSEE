...
```{r graphiques}
    ...
    png("HistBmiSocprof.png", width = 1080, height = 1080)
    ggplot(df, aes(x = df$bmi)) +
        geom_bar(aes(fill = df$socprof)) +
        labs(title = "Histogramme de Bmi coloré par Socprof", x = "Bmi", y = "Nombre", fill = "Modalités") +
        theme(
