...
```{r graphiques}
    ...
    png("PlotTaillePoidsSex.png", width = 1080, height = 1080)
    ggplot(df, aes(x = df$weight, y = df$height, color = df$sex)) +
        geom_point() +
        labs(title = "Height en fonction de Weight coloré par Sex", x = "Weight", y = "Height", color = "Sex") +
        theme(
    ...
    png("PropensionBmiDepress.png", width = 1080, height = 1080)
    ggplot(df.prop, aes(x = depress, y = nofriend, color = score)) +
        geom_point() +
